...
public class SettingsActivity extends BaseActivity {
    ...
    private Switch autoBlockDuringPomodoroSwitch;
    ...
    private void initViews() {
        ...
        autoBlockDuringPomodoroSwitch = findViewById(R.id.auto_block_during_pomodoro_switch);
    ...
    private void setupPomodoroWorkflowSettings() {
        ...
        if (autoBlockDuringPomodoroSwitch != null) {
            autoBlockDuringPomodoroSwitch.setOnCheckedChangeListener((buttonView, isChecked) -> {
                if (!isSpinnerInitialized) {
                    return;
                }
                settingsViewModel.setAutoBlockDuringPomodoro(isChecked);
            });
        }
    ...
    private void applyPomodoroSettingsToUi(UserPomodoroSettings pomodoroSettings) {
        ...
        if (autoBlockDuringPomodoroSwitch != null) {
            autoBlockDuringPomodoroSwitch.setChecked(pomodoroSettings.autoBlockDuringPomodoro);
        }
